...
export interface BlobStore {
  ...
  createWriteStream(options: string | { key: string }, cb?: (err:any, result:any) => void):void;
  
  createReadStream(key: string | { key: string }, options?: any):void
  
  exists(options: string | { key: string }, cb?: (err:any, result:any) => void):void
  
  remove(options: string | { key: string }, cb?: (err:any, result:any) => void):void
}
...
export interface StorageProviderInterface {
   ...
   */
  getSignedUrl(key: string, expiresAfter: number, conditions:any): Promise<SignedURLResponse>
